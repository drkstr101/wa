...
const ContactForm = () => (
  <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
    <h3 className="text-lg font-medium text-neutral-content">Send us a message</h3>
    <form
      action="#"
      method="POST"
    ...
    >
      <div>
        <label htmlFor="first-name" className="block text-sm font-medium text-neutral-content">
          First name
        </label>
        <div className="mt-1">
          <input
            ...
            className="py-3 px-4 block w-full shadow-sm bg-neutral-300 text-neutral-content focus:ring-teal-500 focus:border-teal-500 border-warm-gray-300 rounded-md"
          />
        </div>
      </div>
      <div>
        <label htmlFor="last-name" className="block text-sm font-medium text-neutral-content">
          Last name
        </label>
        <div className="mt-1">
          <input
            ...
            className="py-3 px-4 block w-full shadow-sm text-neutral-content focus:ring-teal-500 focus:border-teal-500 border-warm-gray-300 rounded-md"
          />
        </div>
      </div>
      <div>
      ...
      <div>
        <div className="flex justify-between">
          ...
          <span id="phone-optional" className="text-sm text-secondary-300">
            Optional
          </span>
        </div>
        <div className="mt-1">
      ...
      <div className="sm:col-span-2">
        <label htmlFor="subject" className="block text-sm font-medium text-neutral-content">
          Subject
        </label>
        <div className="mt-1">
          <input
      ...
      <div className="sm:col-span-2">
        <div className="flex justify-between">
          ...
          <span id="message-max" className="text-sm text-secondary-300">
            Max. 500 characters
          </span>
        </div>
        <div className="mt-1">
          <textarea
            ...
            name="message"
            rows={4}
            className="py-3 px-4 block w-full shadow-sm text-neutral-content focus:ring-teal-500 focus:border-teal-500 border border-warm-gray-300 rounded-md"
    ...
    <main className="overflow-hidden">
      ...
      <div className="bg-warm-gray-50">
        <div className="py-24 lg:py-32">
          <div className="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
            <h1 className="text-4xl font-extrabold tracking-tight text-neutral-content sm:text-5xl lg:text-6xl">
              Get in touch
            </h1>
      ...
      <section className="relative" aria-labelledby="contact-heading">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative bg-neutral shadow-xl">
      ...
      <section aria-labelledby="offices-heading">
        <div className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <h2 id="offices-heading" className="text-3xl font-extrabold text-neutral-content">
            Our offices
          </h2>
          <p className="mt-6 text-lg text-secondary-300 max-w-3xl">
          ...
          <div className="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {offices.map((office) => (
              <div key={office.id}>
                <h3 className="text-lg font-medium text-neutral-content">{office.city}</h3>
